let oll_algo = [
    {   'id': 'OLL02',
        'pattern': {'top': 'WWWW#WWWW', 'edge': '_##/###/_#_/_##'},
        'algo': [
            `F (R U R' U') F' Fw (R U R' U') Fw'`,
        ]
    },
    {   'id': 'OLL06',
        'pattern': {'top': 'W##W##WWW', 'edge': '___/##_/__#/##_'},
        'algo': [
            `Rw U2' R' U' R U' Rw'`,
        ]
    },
    {   'id': 'OLL20',
        'pattern': {'top': '#W#W#W#W#', 'edge': '_#_/_#_/_#_/_#_'},
        'algo': [
            `(M' U')4 U2 (M' U')4`,
        ]
    },
    {   'id': 'OLL21',
        'pattern': {'top': 'W#W###W#W', 'edge': '#_#/___/___/#_#'},
        'algo': [
            `(R U2 R' U') (R U R' U' R U' R')`,
        ]
    },
    {   'id': 'OLL22',
        'pattern': {'top': 'W#W###W#W', 'edge': '__#/#_#/___/__#'},
        'algo': [
            `R U2' (R2' U') (R2 U') (R2' U2' R)`,
        ]
    },
    {   'id': 'OLL23',
        'pattern': {'top': '######W#W', 'edge': '___/___/___/#_#'},
        'algo': [
            `x' (R U R' U')2 D (U R U' R')2 D' [x]`,
        ]
    },
    {   'id': 'OLL24',
        'pattern': {'top': 'W#####W##', 'edge': '#__/___/___/#__'},
        'algo': [
            `(r U R' U') r' (F R F')`,
        ]
    },
    {   'id': 'OLL25',
        'pattern': {'top': '##W###W##', 'edge': '__#/__#/___/___'},
        'algo': [
            `Lw' U' L' U R U' L U [x']`,
        ]
    },
    {   'id': 'OLL28',
        'pattern': {'top': '#####W#W#', 'edge': '___/___/_#_/_#_'},
        'algo': [
            `(Rw U R' U') (Rw' R) (U R U' R')`,
        ]
    },
    {   'id': 'OLL37',
        'pattern': {'top': '##W##WWW#', 'edge': '___/___/##_/##_'},
        'algo': [
            `F (R U' R' U') R U R' F'`,
        ]
    },
    {   'id': 'OLL48',
        'pattern': {'top': 'W#W##WWWW', 'edge': '__#/#_#/_#_/_##'},
        'algo': [
            `F (R U R' U')2 F'`,
        ]
    },
    {   'id': 'OLL57',
        'pattern': {'top': '#W#####W#', 'edge': '_#_/___/___/_#_'},
        'algo': [
            `(R U R' U') M' (U R U' Rw') `,
        ]
    },
